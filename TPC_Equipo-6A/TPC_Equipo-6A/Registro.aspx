...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <asp:CompareValidator ID="cvContraseñas" runat="server" ControlToValidate="txbRepetirContraseña" ControlToCompare="txbContraseña" ErrorMessage="Las contraseñas no coinciden." CssClass="text-danger d-block" Display="Dynamic" ValidationGroup="LoginGroup" />
        </div>
        <div class="col-md-6 mb-3">
        ...
        <div class="col-md-6 mb-3">
            ...
            <asp:RequiredFieldValidator ID="rfvRol" runat="server" ControlToValidate="txbRol" CssClass="text-danger d-block" EnableClientScript="true" Display="Dynamic" />
        </div>
        <div class="col-md-6 mb-3">
            ...
            <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="txbEmail" CssClass="text-danger d-block" EnableClientScript="true" Display="Dynamic" />
        </div>
        <div class="col-md-6 mb-3">
